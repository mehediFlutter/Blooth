...
import 'package:blooth_4/view/home/component/connect_btn.dart';
...
class BloothItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isConnected = controller.isConnected(deviceItem);
    final isConnecting = controller.isConnecting(remoteId);
            ...
            children: [
              Row(
                children: [
                  ...
                  if (isConnected)
                    Lottie.asset(AppAssets.connected, height: 40, width: 40),
                ],
              ),
              ...
              Wrap(
                ...
                children: [
                  ...
                  ItemDetailsBlock(
                    child: infoChip(
                      'MSD',
                      manufacturerEntries.length.toString(),
                    ),
                  ),
                ],
              ),
              ...
              ConnectBtn(
                ...
                label: isConnected ? 'Disconnected' : 'Connect',
                onPressed: isConnected
                    ? () => controller.disconnectDevice(deviceItem)
                    : () => controller.connectToDevice(deviceItem),
              ),
            ],
          ),
        ),
